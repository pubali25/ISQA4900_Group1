...
from .views import PasswordResetMPSEmailView, SignUpView,SubscribeView, edit_profile, contact
...
urlpatterns = [
    ...
    path('about/', SubscribeView.as_view(), name='about'),
    ...
    path('subscribe_success/', TemplateView.as_view(template_name='subscription_success.html'), name='subscribe_success'),
